html lang="en">
  <head>
    ...
    <link href="../dashboard_asset/lib/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="">Richard.</a></div>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="../dashboard_asset/img/img3.jpg" class="wd-32 rounded-circle" alt="">
            </a>
